# CLAUDE.md — cloudsmith-inventory

Claude Code context for `cloudsmith-inventory` — one of the code repos in the CloudSmith open-source project.

## What this repo is

WinRM-based Hyper-V host, VM, vSwitch, and storage inventory discovery, sync, and drift detection
